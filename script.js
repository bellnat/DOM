...
let init = function(){
    ...
    //.createElement() creates a new element to be added to the HTML file. This method accepts a parameter of the element's name wish you add.
    //To use this method, we need to first create a variable that represent the element we wish to add.

    //let btn = document.createElement( "BUTTON"); //ONLY CREATES ELEMENT DOES NOT ADD TO THE PAGE
